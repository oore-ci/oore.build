...
- **Smaller, truthfully budgeted web startup**:
  ...
  - The existing dynamically imported `web-vitals` package is reused with no analytics SDK. The full field-metrics path is 168.75 KiB gzip against a 170 KiB post-idle budget while initial JavaScript remains 165.38 KiB.
