...
Before broader rollout, review the [known limitations](/operations/known-limitations).
...
For a full reset of your Oore CI instance, see [Clean reinstall](/operations/clean-reinstall).
...
- Bugs and UX issues: GitHub issues (use the [alpha feedback playbook](/operations/alpha-feedback))
