  ...
  return (
    <PageLayout width="wide">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium uppercase tracking-wider text-muted-foreground">Connection flow</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium uppercase tracking-wider text-muted-foreground">Generated endpoints</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableBody>
